/* ============================================================
   icons.js — Unified SVG Icon System
   所有图标统一 24x24 viewBox, stroke 风格
   用法: <span data-icon="book"></span> 或 Icons.get('book')
   ============================================================ */
...
export const Icons = (function () {
  ...
  const paths = {
    ...
    'sun-moon':  '<circle cx="12" cy="12" r="5"/><path d="M12 1v2M12 1a11 11 0 000 22 11 11 0 000-22z" opacity="0.3"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/>',
    ...
    'terminal':  '<rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/><polyline points="6 8 9 11 6 14"/>',
    ...
    'handshake': '<path d="M11 17a2 2 0 100-4 2 2 0 000 4zm8-7l-3-3-3 3-3-3-3 3v4a2 2 0 002 2h10a2 2 0 002-2v-4z"/>',
    ...
    // 装饰性插画
    'graph':     '<line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/><line x1="3" y1="20" x2="21" y2="20"/>',
  ...
  return { get: get, renderAll: renderAll, colors: colors };
})();
